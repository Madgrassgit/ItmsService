 ...
 *
 */
public class QueryNetChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(QueryNetChecker.class);
	private String inParam = null;

	public QueryNetChecker(String inParam)
	{
	...
	public boolean check()
	{
		...
		logger.debug("QueryNetChecker==>check()"+inParam);
