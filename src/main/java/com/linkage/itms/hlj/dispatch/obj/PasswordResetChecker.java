 ...
 *
 */
public class PasswordResetChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(PasswordResetChecker.class);
