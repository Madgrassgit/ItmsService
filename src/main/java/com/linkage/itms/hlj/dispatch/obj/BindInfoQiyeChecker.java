 ...
 */
public class BindInfoQiyeChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(BindInfoQiyeChecker.class);
	private String inParam = null;

	public BindInfoQiyeChecker(String inParam)
	{
	...
	public boolean check()
	{
		...
		logger.debug("BindInfoQiyeChecker==>check()"+inParam);
