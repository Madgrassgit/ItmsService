 ...
 */
public class ReleaseByIpChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(ReleaseByIpChecker.class);
	private String inParam = null;

	public ReleaseByIpChecker(String inParam)
	{
