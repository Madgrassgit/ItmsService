 ...
 *
 */
public class QuerySuperPwdChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(QuerySuperPwdChecker.class);
	private String inParam = null;

	public QuerySuperPwdChecker(String inParam)
	{
