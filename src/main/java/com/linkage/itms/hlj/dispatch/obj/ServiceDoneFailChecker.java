 ...
 *
 */
public class ServiceDoneFailChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(ServiceDoneFailChecker.class);
	private String inParam = null;

	public ServiceDoneFailChecker(String inParam)
	{
