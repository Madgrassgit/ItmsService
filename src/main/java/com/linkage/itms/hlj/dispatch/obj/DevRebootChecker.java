 ...
 */
public class DevRebootChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(DevRebootChecker.class);
	private String inParam = null;

	public DevRebootChecker(String inParam)
	{
	...
	public boolean check()
	{
		...
		logger.debug("DevRebootChecker==>check()"+inParam);
