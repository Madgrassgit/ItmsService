 ...
 */
public class DevResetChecker extends HljBaseChecker
{

	private static final Logger logger = LoggerFactory.getLogger(DevResetChecker.class);
	private String inParam = null;
	String OpTask = "";

	public DevResetChecker(String inParam)
	{
