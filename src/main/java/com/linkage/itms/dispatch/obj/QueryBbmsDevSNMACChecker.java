...
public class QueryBbmsDevSNMACChecker extends BaseChecker {

	private static final Logger logger = LoggerFactory.getLogger(QueryBbmsDevSNMACChecker.class);
	 ...
	 * @param inXml
	 */
	public QueryBbmsDevSNMACChecker(String inXml){
		callXml = inXml;
	}
