...
public class CloudPingDiagnosticChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudPingDiagnosticChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudPingDiagnosticChecker(String inXml) {
		callXml = inXml;
	}
