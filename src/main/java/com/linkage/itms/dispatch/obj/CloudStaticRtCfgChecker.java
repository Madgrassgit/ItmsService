...
public class CloudStaticRtCfgChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudStaticRtCfgChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudStaticRtCfgChecker(String inXml) {
		callXml = inXml;
	}
