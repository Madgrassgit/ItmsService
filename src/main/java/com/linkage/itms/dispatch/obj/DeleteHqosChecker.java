 ...
 */
public class DeleteHqosChecker extends BaseChecker
{
	private static Logger logger = LoggerFactory.getLogger(DeleteHqosChecker.class);
	...
	public DeleteHqosChecker(String inXml)
	{
		callXml = inXml;
	}
	...
	public boolean check()
	{
		...
		{
			logger.error("DeleteHqosChecker.check error:", e);
		}
