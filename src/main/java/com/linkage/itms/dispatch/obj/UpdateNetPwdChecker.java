 ...
 *
 */
public class UpdateNetPwdChecker extends BaseChecker{

private static final Logger logger = LoggerFactory.getLogger(UpdateNetPwdChecker.class);
	...
	public UpdateNetPwdChecker(String inParam){
	...
	public boolean check(){
		...
		try {
			...
			if("hb_lt".equals(Global.G_instArea)){
				servType = param.elementTextTrim("servType");
			}
		} catch (Exception e) {
		...
		if("sd_lt".equals(Global.G_instArea)){
			if (false == baseCheck() || false == netUserNameCheck() || false == netPwdCheck()) {
				return false;
			}
		}else if("hb_lt".equals(Global.G_instArea)){
			if (false == baseCheck() || false == loidServType() || false == netUserNameCheck() || false == netPwdCheck()) {
				return false;
			}
		}else{
