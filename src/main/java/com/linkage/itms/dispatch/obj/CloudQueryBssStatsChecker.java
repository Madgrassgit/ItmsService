...
public class CloudQueryBssStatsChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudQueryBssStatsChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudQueryBssStatsChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// Ipsec vpn业务下发结果
		par.addElement("BssStats").addText(bssStats);
