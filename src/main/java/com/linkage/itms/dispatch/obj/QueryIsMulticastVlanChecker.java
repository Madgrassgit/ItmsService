 ...
 * 
 */
public class QueryIsMulticastVlanChecker extends BaseChecker {
	private static final Logger logger = LoggerFactory
			.getLogger(QueryIsMulticastVlanChecker.class);

	private String inParam = null;

	public QueryIsMulticastVlanChecker(String inParam) {
