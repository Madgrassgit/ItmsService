...
public class QueryDeviceCurrentChecker extends BaseChecker {
	
	private static final Logger logger = LoggerFactory
			.getLogger(QueryDeviceCurrentChecker.class);
	 ...
	 * @param inXml
	 */
	public QueryDeviceCurrentChecker(String inXml){
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		root.addElement("BiasCurrent").addText("" + biasCurrent);
