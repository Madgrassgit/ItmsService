...
public class CloudQueryDevOnlineChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudQueryDevOnlineChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudQueryDevOnlineChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// 网关业务ip地址
		par.addElement("OnlineStatus").addText(onlineStatus);
