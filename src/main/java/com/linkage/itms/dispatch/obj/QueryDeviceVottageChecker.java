...
public class QueryDeviceVottageChecker extends BaseChecker {
	
	private static final Logger logger = LoggerFactory
			.getLogger(QueryDeviceVottageChecker.class);
	 ...
	 * @param inXml
	 */
	public QueryDeviceVottageChecker(String inXml){
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		root.addElement("SupplyVottage").addText("" + supplyVottage);
