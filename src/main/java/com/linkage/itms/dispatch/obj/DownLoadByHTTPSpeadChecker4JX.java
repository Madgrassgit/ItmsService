 ...
 */
public class DownLoadByHTTPSpeadChecker4JX extends BaseChecker
{
	/**
	 * 宽带速率
	 */
	...
	public DownLoadByHTTPSpeadChecker4JX(String inXml)
	{
		this.callXml = inXml;
	}
...
//			cityId = param.elementTextTrim("CityId");
		...
		if (StringUtil.IsEmpty(downURL) && "xj_dx".equals(Global.G_instArea))
		{
			result = 1;
