...
public class QuerySSIDPowerChecker extends BaseChecker {
	
	private static final Logger logger = LoggerFactory
			.getLogger(QuerySSIDPowerChecker.class);
	 ...
	 * @param inXml
	 */
	public QuerySSIDPowerChecker(String inXml){
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		root.addElement("Transmittingpower").addText("" + power);
