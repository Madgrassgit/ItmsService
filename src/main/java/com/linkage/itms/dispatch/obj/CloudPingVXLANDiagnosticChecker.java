...
public class CloudPingVXLANDiagnosticChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudPingVXLANDiagnosticChecker.class);

	protected String vxlanPassageWay = "";
	 ...
	 * @param inXml XML格式
	 */
	public CloudPingVXLANDiagnosticChecker(String inXml) {
		callXml = inXml;
	}
	...
	public boolean check() {
		...
		try {
			...
			vxlanPassageWay = param.elementTextTrim("VXLANPassageWay");
	...
	public String getVxlanPassageWay() {
		return vxlanPassageWay;
	}

	public void setVxlanPassageWay(String vxlanPassageWay) {
		this.vxlanPassageWay = vxlanPassageWay;
	}
	...
	private boolean isNullCheck() {
		if (//StringUtil.IsEmpty(vxlanPassageWay) || 
				StringUtil.IsEmpty(packageByte) ||
				StringUtil.IsEmpty(packageNum) ||
				//StringUtil.IsEmpty(sourceAddress) ||
				StringUtil.IsEmpty(ipOrDomainName) ||
