...
public class CloudServiceDoneChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudServiceDoneChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudServiceDoneChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// 业务下发结果
		par.addElement("ServiceDoneStats").addText(serviceDoneStats);
