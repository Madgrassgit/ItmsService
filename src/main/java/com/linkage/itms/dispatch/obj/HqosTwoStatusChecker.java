 ...
 */
public class HqosTwoStatusChecker extends BaseChecker
{

	private static Logger logger = LoggerFactory.getLogger(HqosTwoStatusChecker.class);

	public HqosTwoStatusChecker(String inXml)
	{
		callXml = inXml;
	}
