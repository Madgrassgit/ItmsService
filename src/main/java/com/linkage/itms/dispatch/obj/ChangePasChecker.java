...
public class ChangePasChecker extends BaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(ChangePasChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public ChangePasChecker(String inXml) {
		callXml = inXml;
	}
