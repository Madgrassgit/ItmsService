 ...
 *
 */
public class WifiInfoChecker extends BaseChecker
{
	// 日志记录对象
		private static Logger logger = LoggerFactory.getLogger(WifiInfoChecker.class);
	
	//0：不具备  1：具备wif能力
	private int HasWifi;	
		
	public 	WifiInfoChecker(String inXml){
		callXml = inXml;
	}
	...
	public String getReturnXml()
	{
		...
		//是否具有wifi功能
		root.addElement("HasWifi").addText("" + HasWifi);
