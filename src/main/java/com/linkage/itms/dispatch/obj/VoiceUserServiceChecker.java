 ...
 * 
 */
public class VoiceUserServiceChecker extends BaseChecker {
	private static final Logger logger = LoggerFactory
			.getLogger(VoiceUserServiceChecker.class);
	private String inParam = "";
	private String failureReason = "";
	private String succStatus = "";
	private String digitCornet = "";
	private String iSVirtualNetwork = "";

	public VoiceUserServiceChecker(String inParam) {
		this.inParam = inParam;
	}

	@Override
	public boolean check() {
		logger.debug("VoiceUserServiceChecker==>check()");
	...
	public String getReturnXml() {
		logger.debug("VoiceUserServiceChecker==>getReturnXml()");
		...
		root.addElement("ISVirtualNetwork").addText(iSVirtualNetwork);
	...
	public String getiSVirtualNetwork() {
		return iSVirtualNetwork;
	}

	public void setiSVirtualNetwork(String iSVirtualNetwork) {
		this.iSVirtualNetwork = iSVirtualNetwork;
	}
