...
public class TestSpeedCheckerUpAndDownHBLT extends BaseChecker{

	
	private static Logger logger = LoggerFactory.getLogger(TestSpeedCheckerUpAndDownHBLT.class);
	 ...
	 *            接口调用入参，xml字符串
	 */
	public TestSpeedCheckerUpAndDownHBLT(String inXml) {
		this.callXml = inXml;
	}
	/**
	 * 检查接口调用字符串的合法性
