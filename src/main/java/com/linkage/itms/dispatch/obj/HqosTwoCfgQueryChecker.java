 ...
 */
public class HqosTwoCfgQueryChecker extends BaseChecker
{

	private static Logger logger = LoggerFactory.getLogger(HqosTwoCfgQueryChecker.class);
	private String  requestTime;
	private String  finishTime;

	public HqosTwoCfgQueryChecker(String inXml)
	{
		callXml = inXml;
	}
	...
	public boolean check()
	{
		...
		{
			logger.error("HqosTwoStatusChecker.check error:", e);
		}
	...
	public String getReturnXml()
	{
		...
		root.addElement("requestTime").addText(StringUtil.getStringValue(requestTime));
		root.addElement("finishTime").addText(StringUtil.getStringValue(finishTime));
