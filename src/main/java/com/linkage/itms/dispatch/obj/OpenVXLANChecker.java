 ...
 *
 */
public class OpenVXLANChecker extends VXLANBaseChecker
{
	private static final Logger logger = LoggerFactory.getLogger(OpenVXLANChecker.class);

	private String inParam = null;

	public OpenVXLANChecker(String inParam) {
		this.inParam = inParam;
	}

	@Override
	public boolean check() {
		logger.debug("OpenVXLANChecker==>check()" + inParam);
