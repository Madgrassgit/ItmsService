 ...
 */
public class DeleteIpsecVPNChecker extends IpsecBaseChecker {
	private static final Logger logger = LoggerFactory.getLogger(DeleteIpsecVPNChecker.class);

	private String inParam = null;

	public DeleteIpsecVPNChecker(String inParam) {
		this.inParam = inParam;
	}

	@Override
	public boolean check() {
		logger.debug("DeleteIpsecVPNChecker==>check()" + inParam);
