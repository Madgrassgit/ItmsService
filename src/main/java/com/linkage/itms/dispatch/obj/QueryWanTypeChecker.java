 ...
 * @date 2015-03-10
 */
public class QueryWanTypeChecker extends BaseChecker {
	
	private static Logger logger = LoggerFactory.getLogger(QueryWanTypeChecker.class);
	//上网方式
	protected int wanType;
	...
	public QueryWanTypeChecker(String _callXml) {
		logger.debug("QueryWanTypeChecker({})", _callXml);
		callXml = _callXml;
	}
	...
	public String getReturnXml() {
		...
		root.addElement("RstMsg").addText("" + resultDesc);
		// 上网方式
		root.addElement("WanType").addText("" + wanType);
