 ...
 */
public class OpenHqosChecker extends BaseChecker
{
	private static Logger logger = LoggerFactory.getLogger(OpenHqosChecker.class);
	...
	public OpenHqosChecker(String inXml)
	{
		callXml = inXml;
	}
	...
	public boolean check()
	{
		...
		try
		{
			...
			businessId = param.elementTextTrim("business_id");
			servTypeId="46";
			operateId="1";
		}
		catch (Exception e)
