 ...
 */
public class HqosQueryNetStatusChecker extends BaseChecker
{

	private static Logger logger = LoggerFactory.getLogger(HqosQueryNetStatusChecker.class);
	private String vendor;
	private String devModel;

	public HqosQueryNetStatusChecker(String inXml)
	{
		callXml = inXml;
	}
	...
	public boolean check()
	{
		...
		{
			logger.error("HqosQueryNetStatusChecker.check error:", e);
		}
	...
	public String getReturnXml()
	{
		...
		root.addElement("vendor").addText(StringUtil.getStringValue(vendor));
		root.addElement("devModel").addText(StringUtil.getStringValue(devModel));
		root.addElement("userName").addText(StringUtil.getStringValue(userName));
