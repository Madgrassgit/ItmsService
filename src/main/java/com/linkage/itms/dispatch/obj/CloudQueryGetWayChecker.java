...
public class CloudQueryGetWayChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudQueryGetWayChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudQueryGetWayChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// 是否有IPSecVpn业务
		par.addElement("IsIpsecVPN").addText(isIpsecVPN);
		// 上网方式
		...
		// Ipsec通道状态
		par.addElement("IpsecStatus").addText(ipsecStatus);
