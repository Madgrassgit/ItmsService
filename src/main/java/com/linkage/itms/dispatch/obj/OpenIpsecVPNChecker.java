 ...
 */
public class OpenIpsecVPNChecker extends IpsecBaseChecker {
	private static final Logger logger = LoggerFactory.getLogger(OpenIpsecVPNChecker.class);

	private String inParam = null;

	public OpenIpsecVPNChecker(String inParam) {
		this.inParam = inParam;
	}

	@Override
	public boolean check() {
		logger.debug("OpenIpsecVPNChecker==>check()" + inParam);
