...
public class CloudVXLANServiceDoneChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudVXLANServiceDoneChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudVXLANServiceDoneChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// 业务下发结果
		par.addElement("VXLANServiceDoneStats").addText(serviceDoneStats);
