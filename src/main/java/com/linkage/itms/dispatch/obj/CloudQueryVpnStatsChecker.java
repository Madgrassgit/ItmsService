...
public class CloudQueryVpnStatsChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudQueryVpnStatsChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudQueryVpnStatsChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		{
			par.addElement("IPSecVpnStatus").addText(ipescVpnStatus);
		}
		else
		{
			// 网关业务ip地址
			par.addElement("OnlineStatus").addText(ipescVpnStatus);
		}
