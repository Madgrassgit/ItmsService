...
public class CloudGetWayRebootChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudGetWayRebootChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudGetWayRebootChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// 业务下发结果
		par.addElement("RebootStats").addText(rebootStats);
