...
public class CloudQueryVXLANBssStatsChecker extends CloudBaseChecker {

	public static final Logger logger = LoggerFactory.getLogger(CloudQueryVXLANBssStatsChecker.class);
	 ...
	 * @param inXml XML格式
	 */
	public CloudQueryVXLANBssStatsChecker(String inXml) {
		callXml = inXml;
	}
	...
	public String getReturnXml() {
		...
		// Ipsec vpn业务下发结果
		par.addElement("VXLANBssStats").addText(bssStats);
