 ...
 *
 */
public class TestSpeedService4JLLT implements IService{

	private static Logger logger = LoggerFactory.getLogger(TestSpeedService4JLLT.class);
	private final String methodName = "TestSpeedService4JLLT";
	
	public static void main(String[] args)
	{
		new TestSpeedService4JLLT().work("<root><Param><op_id>1574928979230</op_id><type>0</type><index>43101HW511219078</index><SpeedTest_DiagnosticsState>Requested</SpeedTest_DiagnosticsState><SpeedTest_testMode>serverMode</SpeedTest_testMode><SpeedTest_downloadURL></SpeedTest_downloadURL><SpeedTest_testURL>http://218.27.253.1:8094/speedfile/services/contractrate/contract/rate/</SpeedTest_testURL><SpeedTest_reportURL>http://218.27.253.1:8094/speedfile/services/contractrate/results/insert/</SpeedTest_reportURL></Param></root>");
	}
	@Override
	public String work(String inParam) {
		...
		// 解析获得入参
		TestSpeedChecker4JLLT checker = new TestSpeedChecker4JLLT(inParam.trim());
	...
	public String doTest(TestSpeedChecker4JLLT checker,String deviceId) throws Exception{
