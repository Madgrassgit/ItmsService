...
public class VoiceDial4ctc implements IService
{

	private static Logger logger = LoggerFactory.getLogger(VoiceDial4ctc.class);
	private static String TestNode = "InternetGatewayDevice.Services.VoiceService.1.PhyInterface.1.Tests.X_CT-COM_SimulateTest.";
	...
	private static String DialDTMFConfirmEnable = TestNode + "DailDTMFConfirmEnable";
	private static String DialDTMFConfirmNumber = TestNode + "DailDTMFConfirmNumber";
	private static String DialDTMFConfirmResult = TestNode + "DailDTMFConfirmResult";
	...
	private static String StartTest = "InternetGatewayDevice.Services.VoiceService.1.PhyInterface.1.Tests.";
	private static String TestState = StartTest + "TestState";
	private static String TestSelector = StartTest + "TestSelector";
	
	public String work(String inXml)
	{
		logger.warn("VoiceDial4ctc==>inXml({})", inXml);
	...
	public String voiceDial(String gw_type, String deviceId, VoiceDialChecker checker)
	{
		...
		anyObject = new AnyObject();
		if("gs_dx".equals(Global.G_instArea))
		{
			anyObject.para_value = checker.getDialDTMFConfirmEnable().equalsIgnoreCase("true") ? "1" : "0";
		...
		ParameterValueStruct[4].setName(TestState);
		anyObject = new AnyObject();
		...
		anyObject = new AnyObject();
		anyObject.para_value = "X_CT-COM_SimulateTest";
		anyObject.para_type_id = "1";
