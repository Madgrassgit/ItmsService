 ...
 * @since 2016-10-13
 */
public class DevConfigServiceNew implements IService
{
	
	// 日志记录
	private static final Logger logger = LoggerFactory.getLogger(DevConfigServiceNew.class);
	...
	public String work(String inXml)
 {
	...
	private void ponInfo(String accessType, String deviceId,
		...
		if ("GPON".equals(accessType)) {
			gatherPath = new String[] { this.ststusPatchGPON,
					this.txPowerPatchGPON, this.rxPowerGPON, };
		}
		...
		logger.warn("[{}]status[{}]txpower[{}]rxPower[{}]", deviceId, status, tx_power, rx_power);
