...
import com.linkage.itms.dispatch.obj.PingConnectivityChecker;


public class PingConnectivityService implements IService {
	...
	private void writeLog(PingConnectivityChecker checker) {
		checker.setCmdId("1234567890");
		new RecordLogDAO().recordDispatchLog(checker, "PingConnectivityService", checker.getIp());
