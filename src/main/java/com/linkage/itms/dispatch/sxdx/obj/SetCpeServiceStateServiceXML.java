...
public class SetCpeServiceStateServiceXML extends BaseDealXML {
    private static Logger logger = LoggerFactory.getLogger(SetCpeServiceStateServiceXML.class);
    SAXReader reader = new SAXReader();

    public SetCpeServiceStateServiceXML(String methodName) {
        super(methodName);
    }
    ...
    public Document getXML(String inXml) {
        ...
        try {
            ...
            serviceType =  StringUtil.getStringValue(inRoot.elementTextTrim("serviceType"));
            serviceState =  StringUtil.getStringValue(inRoot.elementTextTrim("serviceState"));
			/*1：终端唯一标识
