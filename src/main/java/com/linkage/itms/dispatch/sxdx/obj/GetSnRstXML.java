...
public class GetSnRstXML extends BaseDealXML {
	public GetSnRstXML(String methodName) {
		super(methodName);
	}
	private static Logger logger = LoggerFactory.getLogger(GetSnRstXML.class);
