...
public class GetVoipPWDXML extends BaseDealXML {
	public GetVoipPWDXML(String methodName) {
		super(methodName);
	}
	private static Logger logger = LoggerFactory.getLogger(GetVoipPWDXML.class);
