...
public class GetXDSLInfoXML  extends BaseDealXML {
	public GetXDSLInfoXML(String methodName) {
		super(methodName);
	}
	private static Logger logger = LoggerFactory.getLogger(GetXDSLInfoXML.class);
