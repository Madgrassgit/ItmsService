 ...
 *
 */
public class CpeRebootDealXML extends BaseDealXML {
	private static Logger logger = LoggerFactory.getLogger(CpeRebootDealXML.class);
	SAXReader reader = new SAXReader();

	private String index = "";
	private String type = "";
	
	public CpeRebootDealXML(String methodName){
		super(methodName);
	}
