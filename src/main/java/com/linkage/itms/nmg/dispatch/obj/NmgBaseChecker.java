 ...
 * @date 2010-6-17
 */
public abstract class NmgBaseChecker {
	
	private static Logger logger = LoggerFactory.getLogger(NmgBaseChecker.class);
	...
	// 调用客户端类型：1：BSS 2：IPOSS 3：综调 4：RADIUS 5:掌上运维
