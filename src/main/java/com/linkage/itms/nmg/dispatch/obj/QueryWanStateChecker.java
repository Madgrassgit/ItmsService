...
public class QueryWanStateChecker extends NmgBaseChecker
{

	private static final Logger logger = LoggerFactory
			.getLogger(QueryWanStateChecker.class);
	 ...
	 * @param inXml
	 */
	public QueryWanStateChecker(String inXml)
	{
		callXml = inXml;
	}
	...
	public String getReturnXml()
	{
		...
		Element wanPorts = root.addElement("WanPort");
		if (wanList != null && wanList.size() > 0)
		{
			...
			wanPorts.addElement("WanPortName").addText("1");
			wanPorts.addElement("RstState").addText(status);
			wanPorts.addElement("BytesReceived").addText(BytesReceived);
			wanPorts.addElement("BytesSent").addText(BytesSent);
		}
