 ...
 * 
 * @author songxq
 * @date 2018-7-26 下午2:29:59
 */
public abstract class NxBaseChecker {
	
	private static Logger logger = LoggerFactory.getLogger(NxBaseChecker.class);
	...
	// 调用客户端类型：1：BSS 2：IPOSS 3：综调 4：RADIUS 5:爱运维  6：预处理
	...
	*/
	...
	protected boolean cityIdCheck(){
		if("nx_dx".equals(Global.G_instArea) || "nmg_dx".equals(Global.G_instArea) || "cq_dx".equals(Global.G_instArea)){
			return true;
		}
