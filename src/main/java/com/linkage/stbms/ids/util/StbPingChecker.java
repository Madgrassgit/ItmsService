...
public class StbPingChecker extends BaseChecker{
	
	private static final Logger logger = LoggerFactory.getLogger(StbPingChecker.class);
	
	private String inParam = null;

	public StbPingChecker(String inParam){
	...
	public String getReturnXml(){
		...
		if("jx_dx".equals(Global.G_instArea)){
			...
			root.addElement("SearchInfo").addText(StringUtil.getStringValue(searchInfo));
			root.addElement("Result").addText(rstCode);
		} 
