...
public class StbResetChecker extends BaseChecker{
	
	private static final Logger logger = LoggerFactory.getLogger(StbResetChecker.class);
	
	private String inParam = null;

	// 有参构造函数
	public StbResetChecker(String inParam){
