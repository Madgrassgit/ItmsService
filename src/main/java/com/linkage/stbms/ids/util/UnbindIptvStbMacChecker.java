...
public class UnbindIptvStbMacChecker extends BaseChecker{
	
	private static final Logger logger = LoggerFactory.getLogger(UnbindIptvStbMacChecker.class);
	
	private String inParam = null;

	public UnbindIptvStbMacChecker(String inParam){
