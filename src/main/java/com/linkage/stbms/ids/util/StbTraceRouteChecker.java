...
public class StbTraceRouteChecker extends BaseChecker{
	
	private static final Logger logger = LoggerFactory.getLogger(StbTraceRouteChecker.class);
	
	private String inParam = null;

	public StbTraceRouteChecker(String inParam){
