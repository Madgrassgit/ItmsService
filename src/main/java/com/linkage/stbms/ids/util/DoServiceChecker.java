...
public class DoServiceChecker extends BaseChecker{
	
	private static final Logger logger = LoggerFactory.getLogger(DoServiceChecker.class);
	
	private String inParam = null;

	public DoServiceChecker(String inParam){
