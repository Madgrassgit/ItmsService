...
public class StbRebootChecker extends BaseChecker{
	
	private static final Logger logger = LoggerFactory.getLogger(StbRebootChecker.class);
	
	private String inParam = null;

	public StbRebootChecker(String inParam){
